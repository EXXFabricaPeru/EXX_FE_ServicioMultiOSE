...
namespace ServicioConectorFE.IntegradorEstelaBaja {
    ...
    public class ArrayOfBajas : System.Collections.Generic.List<ServicioConectorFE.IntegradorEstelaBaja.bajas> {
    }
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dbnet.cl", ConfigurationName="IntegradorEstelaBaja.WssCargaBajasSoap")]
    public interface WssCargaBajasSoap {
        ...
        ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse cargaBajas(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.dbnet.cl/cargaBajas", ReplyAction="*")]
        System.Threading.Tasks.Task<ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse> cargaBajasAsync(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest request);
    }
    ...
    public partial class cargaBajasRequest {
        ...
        public ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequestBody Body;
        
        public cargaBajasRequest() {
        }
        
        public cargaBajasRequest(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class cargaBajasRequestBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=1)]
        public ServicioConectorFE.IntegradorEstelaBaja.ArrayOfBajas ArchivoBajas;
        
        public cargaBajasRequestBody() {
        }
        
        public cargaBajasRequestBody(string RUC, ServicioConectorFE.IntegradorEstelaBaja.ArrayOfBajas ArchivoBajas) {
            this.RUC = RUC;
    ...
    public partial class cargaBajasResponse {
        ...
        public ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponseBody Body;
        
        public cargaBajasResponse() {
        }
        
        public cargaBajasResponse(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class cargaBajasResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public ServicioConectorFE.IntegradorEstelaBaja.Mensaje cargaBajasResult;
        
        public cargaBajasResponseBody() {
        }
        
        public cargaBajasResponseBody(ServicioConectorFE.IntegradorEstelaBaja.Mensaje cargaBajasResult) {
            this.cargaBajasResult = cargaBajasResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WssCargaBajasSoapChannel : ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WssCargaBajasSoapClient : System.ServiceModel.ClientBase<ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap>, ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap.cargaBajas(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest request) {
            return base.Channel.cargaBajas(request);
        }
        
        public ServicioConectorFE.IntegradorEstelaBaja.Mensaje cargaBajas(string RUC, ServicioConectorFE.IntegradorEstelaBaja.ArrayOfBajas ArchivoBajas) {
            ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest inValue = new ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest();
            inValue.Body = new ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequestBody();
            inValue.Body.RUC = RUC;
            inValue.Body.ArchivoBajas = ArchivoBajas;
            ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse retVal = ((ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap)(this)).cargaBajas(inValue);
            return retVal.Body.cargaBajasResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse> ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap.cargaBajasAsync(ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest request) {
            return base.Channel.cargaBajasAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicioConectorFE.IntegradorEstelaBaja.cargaBajasResponse> cargaBajasAsync(string RUC, ServicioConectorFE.IntegradorEstelaBaja.ArrayOfBajas ArchivoBajas) {
            ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest inValue = new ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequest();
            inValue.Body = new ServicioConectorFE.IntegradorEstelaBaja.cargaBajasRequestBody();
            inValue.Body.RUC = RUC;
            inValue.Body.ArchivoBajas = ArchivoBajas;
            return ((ServicioConectorFE.IntegradorEstelaBaja.WssCargaBajasSoap)(this)).cargaBajasAsync(inValue);
        }
    }
}
