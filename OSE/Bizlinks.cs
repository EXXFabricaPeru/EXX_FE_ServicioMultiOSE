    ...
    public class Bizlinks
    {
        ...
        public static bool RegistrarDocumento(string docmun, int objectype, string tipodocumento, string Tabla, int docentry, ref string EstadoDocumento, ref string Folio, ref string mensaje_error)
        {
            ...
            try
            {
                ...
                if (oBeFEDOC.tipoComprobante == "01" || oBeFEDOC.tipoComprobante == "03")
                {
                    //Cadena += "A3;codiDetraccion;;" + oBeFEDOC. + Environment.NewLine;
                    //Cadena += "A3;ValorDetraccion;;" + dato + Environment.NewLine;
                    //Cadena += "A3;MntDetraccion;;" + dato + Environment.NewLine;
                    //Cadena += "A3;PorcentajeDetraccion;;" + dato + Environment.NewLine;

                    //Información de Forma de pago
                    Cadena += "A;FormaPago;;" + (oBeFEDOC.credito == "Y" ? "Credito" : "Contado") + Environment.NewLine;
                    Cadena += "A;MontoNetoPendPago;;" + (oBeFEDOC.credito == "Y" ? oBeFEDOC.importeTotal : "0.00") + Environment.NewLine;

                    if (oBeFEDOC.credito == "Y")
                    {
                        Cadena += "A5;Cuota;1;Cuota001" + Environment.NewLine;
                        Cadena += "A5;MontoCuota;1;" + oBeFEDOC.importeTotal + Environment.NewLine;
                ...
                for (int i = 0; i < oBeFEDOC.Detalles.Count; i++)
                {
                    ...
                    Cadena += "B;NmbItem;" + (i + 1) + ";" + oBeFEDOC.Detalles[i].descripcion + Environment.NewLine;
                ...
                try
                {
                    System.IO.File.WriteAllText(Globals.PathArchivos + oBeFEDOC.emisor.ruc + "_" + oBeFEDOC.tipoComprobante + "_" + oBeFEDOC.serie + "_" + oBeFEDOC.correlativo + ".TXT", Cadena);
