...
namespace ServicioConectorFE.Entities.Paperless
{
    ...
    {  //EN
        ...
        public string totalDetraccionMD { get; set; } //Moneda del Documento
        ...
        public string U_EXT_DESRESOLIDA { get; set; }
        public string U_EXT_RESPSOLIDA { get; set; }
        public string U_EXT_OSNRO { get; set; }
        public string U_EXT_MUELLE { get; set; }
        public string U_EXT_VIAJE { get; set; }
        public string U_EXT_FECARRIBO { get; set; }
        public string U_EXT_COMENTARIO { get; set; }
        
        public string Comments { get; set; }
        public string U_EXT_dc_fact_VBWONbr { get; set; }
    ...
    public class DocLine
    {
        ...
        public string CondicionCarga { get; set; }
